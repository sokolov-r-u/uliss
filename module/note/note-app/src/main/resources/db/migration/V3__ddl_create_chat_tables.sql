...
-- A turn is one durable user intent and its eventual assistant result. Its id is generated by the
-- backend; the client-generated idempotency key is scoped to the chat.
...
(
    ...
    CONSTRAINT uq_chat_turn_chat_idempotency_key UNIQUE (chat_id, idempotency_key),
